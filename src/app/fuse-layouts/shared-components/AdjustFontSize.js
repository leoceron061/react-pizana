  ...
  return (
    <div style={{color:"white"}}>
      <IconButton style={{color:"white"}}
        ...
        size="large"
      >
        <Icon style={{color:"white"}}>format_size</Icon>
      </IconButton>
      ...
      >
        <div className="py-12 px-24" style={{color:"white"}}>
          <Typography className="flex items-center justify-center text-16 font-Regular mb-8" style={{color:"white"}}>
            <Icon color="white" className="mr-4" style={{color:"white"}}>
              format_size
            </Icon>
            Font Size
          </Typography>
          <Slider style={{color:"white"}}
            classes={{ markLabel: 'text-12 font-Regular' }}
            value={fontSize}
            track={false}
