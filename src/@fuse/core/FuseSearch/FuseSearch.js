    ...
    <MenuItem selected={isHighlighted} component="div">
      <ListItemIcon className="min-w-40">
        {suggestion.icon ? (
          ...
          <span className="text-20 w-24 font-Regular uppercase text-center">
            {suggestion.title[0]}
          </span>
        )}
      </ListItemIcon>
...
function FuseSearch(props) {
  ...
  switch (props.variant) {
    case 'basic': {
      return (
        <div className={clsx('flex items-center w-full', props.className)} ref={popperNode} style={{color:"white"}}>
          <Autosuggest
            {...autosuggestProps}
            inputProps={{
