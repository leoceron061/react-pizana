            ...
            <Tooltip title={item.title || ''} placement="right">
              <div className="w-32 h-32 min-h-32 flex items-center justify-center relative">
                {item.icon ? (
                  ...
                  item.title && <div className="font-Regular text-16">{item.title[0]}</div>
                )}
                {item.badge && (
                  <FuseNavBadge
                    badge={item.badge}
            ...
            <>
              <div className="w-32 h-32 min-h-32 flex items-center justify-center relative mb-8">
                {item.icon ? (
                  ...
                  item.title && <div className="font-Regular text-20">{item.title[0]}</div>
                )}
                {item.badge && (
                  <FuseNavBadge
                    badge={item.badge}
              ...
              <ListItemText
                ...
                primary={item.title}
                classes={{
                  primary: 'text-12 font-Regular fuse-list-item-text-primary truncate text-center',
                }}
              />
            </>
          )}
