  ...
  theme: {
    ...
    fontFamily: {
      sans: [
        ...
        '"Segoe UI Symbol"',
        '"Noto Color Emoji"',
        'Poppins', 'sans-serif','Courier Prime',
       

      ],
      serif: ['Georgia', 'Cambria', '"Times New Roman"', 'Times', 'serif','sans-serif', 'poppins','Courier Prime'],
      mono: ['Consolas', '"Liberation Mono"', 'Menlo', 'Courier', 'monospace', 'poppins'],
    },
    fontSize: {
